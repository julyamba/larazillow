<template>
    <form @submit.prevent="filter">
        <div class="mb-8 mt-4 flex flex-wrap gap-2">
            ...
            <div class="flex flex-nowrap items-center">
                <input v-model.number="filterForm.areaFrom" placeholder="Area from" class="input-filter-l w-28" />
                <input v-model.number="filterForm.areaTo" placeholder="Area to" class="input-filter-r w-28" />
            </div>
